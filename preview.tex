...
%TODO
% - Cap 2: falta uma primeira sessão onde explica o que é cloud
%    computing (IaaS, SaaS, PaaS), além da motivação para empregar cloud computing no ensino
%    de sistemas distribuídos. 
% - Cap 2: uma sessão para listar casos de uso de
%    disciplinas/cursos/universidades que utilizam cloud para ensino.
